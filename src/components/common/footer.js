...
const Footer = () => {
  const [show, showChange] = React.useState(false);
  return (
    <div className="ftr" style={{ minHeight: show ? "32rem" : "0rem" }}>
      <div className="ftr-content">
        <div className="container">
          <div className="row">
            <div className="d-block d-md-none d-lg-none col-12">
              <div className="ftr-show" onClick={() => showChange(!show)}>
                Nutaan Online Shopping Experience
                <span
                  className={(show ? "d-block " : "d-none ") + "ftr-show-arrow"}
                >
                  <i className="fa fa-angle-down" aria-hidden="true"></i>
                </span>
                <span
                  className={(show ? "d-none " : "d-block ") + "ftr-show-arrow"}
                >
          ...
          <div className={show ? "d-block" : "d-none d-md-block"}>
            <div className="container">
              <div className="row">
                ...
                <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                  <div className="d-none d-md-block">
                    <div className="ftr-content-head">Trending Searches</div>
                    <div className="coloumn ">
                      <div className=" col-lg-12 col-md-12 col-sm-6 col-xs-6 px-0">
                        <div className="ftr-content-data">Home</div>
                      </div>
